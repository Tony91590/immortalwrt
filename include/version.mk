...
VERSION_CODE:=$(if $(VERSION_CODE),$(VERSION_CODE),$(REVISION),18.06-SNAPSHOT)

VERSION_REPO:=$(call qstrip,$(CONFIG_VERSION_REPO))
VERSION_REPO:=$(if $(VERSION_REPO),$(VERSION_REPO),https://downloads.openwrt.org/releases/18.06-SNAPSHOT)
